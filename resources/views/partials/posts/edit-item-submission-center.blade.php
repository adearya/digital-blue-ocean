<section class="container edit-item mt-4 bg-white rounded">
  ...
  <div class="container bg-main-content-submissioncenter mt-3 p-5">
    ...
    <div class="container justify-content-center bg-white mt-5 rounded p-3 d-flex">
      ...
      <div class="dropdown">
        <button class="btn btn-primary dropdown-toggle" type="button" id="languageDropdown" data-bs-toggle="dropdown" aria-expanded="false">Choose language</button>
    ...
    <div class="container publication-details bg-white mt-5 p-3">
      ...
      <div class="container content-refereed-publicationdetails d-flex gap-3 mt-5">
        ...
        <div class="d-block">
          <div class="form-check">
            ...
            <input class="form-check-input" type="radio" name="refereed" id="refereed1" value="option1" checked>Yes, this version has been refereed.</label>
          </div>
          <div class="form-check">
            <label class="form-check-label" for="refereed2">
            <input class="form-check-input" type="radio" name="refereed" id="refereed2" value="option2">No, this version has not been refereed.</label>
          </div>
        </div>
      </div>    
      ...
      <div class="form-check">
        ...
        <input class="form-check-input" type="radio" name="status" id="status1" value="option1" checked>Published</label>
      </div>
      <div class="form-check">
          <label class="form-check-label" for="status2">
          <input class="form-check-input" type="radio" name="status" id="status2" value="option2">In Press</label>
      </div>
      <div class="form-check">
          <label class="form-check-label" for="status3">
          <input class="form-check-input" type="radio" name="status" id="status3" value="option2">Submitted</label>
      </div>
      <div class="form-check">
          <label class="form-check-label" for="status4">
          <input class="form-check-input" type="radio" name="status" id="status4" value="option2">Unpublished</label>
      </div>
    </div>
    ...
    <div class="form-check">
      ...
      <input class="form-check-input" type="radio" name="datatype" id="datatype1" value="option1" checked>UNSPECIFIED</label>
    </div>
    <div class="form-check">
      <label class="form-check-label" for="datatype2">
      <input class="form-check-input" type="radio" name="datatype" id="datatype2" value="option2">Publication</label>
    </div>
    <div class="form-check">
      <label class="form-check-label" for="datatype3">
      <input class="form-check-input" type="radio" name="datatype" id="datatype3" value="option2">Submission</label>
    </div>
    <div class="form-check">
      <label class="form-check-label" for="datatype4">
      <input class="form-check-input" type="radio" name="datatype" id="datatype4" value="option2">Completion</label>
    </div>
  ...
  <div class="accordion mt-5" id="accordionContactEmail">
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingContactEmail">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseContactEmail" aria-expanded="true" aria-controls="collapseContactEmail">Contact Email Address</button>
      </h2>
  ...
  <div class="accordion mt-5" id="accordionReferences">
    <div class="accordion-item">
      <h2 class="accordion-header" id="headingReferences">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseReferences" aria-expanded="true" aria-controls="collapseReferences">References</button>
      </h2>
