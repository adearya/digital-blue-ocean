<div class="container detail-page mt-4 rounded bg-white">
  <div class="container pt-4 header-text">
    ...
    <p class="text-center mt-3">Frensia Tanaga Anaclaudia, Dian Pramana, I Made Arya Budhi Saputra<br>APTISI Transactions on Technopreneurship (ATT), Vol 5. No 3. ISSN 2656-8888 (2023)</p>
    <h3>Abstract</h3>
